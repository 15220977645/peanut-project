  ...
  return _(e) === !1
    ...
    : ((r = e.constructor),
      r === void 0
        ? !0
        : ((n = r.prototype),
          !(_(n) === !1 || n.hasOwnProperty("isPrototypeOf") === !1)));
}
function O() {
  return (
    (O = Object.assign
...
const k = { silent: !1, logLevel: "warn" },
  B = ["validator"],
  S = Object.prototype,
  A = S.toString,
  D = S.hasOwnProperty,
...
function $(e) {
  var r;
  const n = (r = e == null ? void 0 : e.type) !== null && r !== void 0 ? r : e;
  if (n) {
    const t = n.toString().match(N);
    return t ? t[1] : "";
  }
  return "";
}
...
const h = (e, r) => D.call(e, r),
  ...
  g = e => A.call(e) === "[object Function]",
  m = (e, r) =>
    y(e) && h(e, "_vueTypes_name") && (!r || e._vueTypes_name === r),
  V = e =>
    y(e) &&
    (h(e, "type") ||
...
function v(e, r, n = !1) {
  ...
  if (V(t) && t.type !== null) {
    if (t.type === void 0 || t.type === !0 || (!t.required && r == null))
      return i;
    b(t.type)
      ? ((i = t.type.some(s => v(s, r, !0) === !0)),
        (a = t.type.map(s => $(s)).join(" or ")))
      : ((a = $(t)),
        (i =
          a === "Array"
            ? b(r)
  ...
  if (!i) {
    const s = `${o}value "${r}" should be of type "${a}"`;
    return n === !1 ? (c(s), !1) : s;
  }
  if (h(t, "validator") && g(t.validator)) {
    ...
    if (
      ...
      const l =
        ...
        u.join(`
* `);
      return (u.length = 0), n === !1 ? (c(l), i) : l;
    }
  }
  return i;
}
function f(e, r) {
  const n = Object.defineProperties(r, {
    ...
    { validator: t } = n;
  return g(t) && (n.validator = T(t, n)), n;
}
function d(e, r) {
  const n = f(e, r);
...
function w(e, r, n) {
  ...
  if (((t._vueTypes_name = e), !y(n))) return t;
  const { validator: i } = n,
    a = x(n, B);
  if (g(i)) {
    let { validator: u } = t;
    u && (u = (s = (o = u).__original) !== null && s !== void 0 ? s : o),
      (t.validator = T(
        u
          ? function (l) {
...
const Y = () => d("any", {}),
  C = () => d("function", { type: Function }),
  P = () => d("boolean", { type: Boolean }),
  ...
  U = () =>
    f("integer", {
      ...
      validator(e) {
        const r = L(e);
        return r === !1 && c(`integer - "${e}" is not an integer`), r;
      }
    }),
  z = () =>
    f("symbol", {
      validator(e) {
        ...
        return r === !1 && c(`symbol - invalid value "${e}"`), r;
      }
    }),
  G = () =>
    Object.defineProperty(
      {
        ...
        validator(e) {
          const r = e === null;
          return r === !1 && c("nullable - value should be null"), r;
        }
      },
      "_vueTypes_name",
      { value: "nullable" }
    );
function H(e, r = "custom validation failed") {
  if (typeof e != "function")
    throw new TypeError(
      "[VueTypes error]: You must provide a function as argument"
    );
  return f(e.name || "<<anonymous function>>", {
    type: null,
    validator(n) {
      const t = e(n);
      return t || c(`${this._vueTypes_name} - ${r}`), t;
    }
  });
}
function K(e) {
...
function Q(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const o = e[a];
    if (V(o)) {
      if ((g(o.validator) && (r = !0), m(o, "oneOf") && o.type)) {
        t = t.concat(o.type);
        continue;
      }
      if (m(o, "nullable")) {
...
function W(e) {
  return f("arrayOf", {
    ...
    validator(r) {
      let n = "";
      const t = r.every(i => ((n = v(e, i, !0)), n === !0));
      return (
        t ||
...
function Z(e) {
  return f("objectOf", {
    ...
    validator(r) {
      let n = "";
      const t = Object.keys(r).every(i => ((n = v(e, r[i], !0)), n === !0));
      return (
        t ||
  ...
  const r = Object.keys(e),
    ...
    t = f("shape", {
      ...
      validator(i) {
        ...
        if (n.length > 0 && n.some(o => a.indexOf(o) === -1)) {
          const o = n.filter(s => a.indexOf(s) === -1);
          return (
            c(
              o.length === 1
        ...
        return a.every(o => {
          ...
          return (
            typeof s == "string" &&
              c(`shape - "${o}" property validation error:
 ${j(s)}`),
            s === !0
          );
        });
  ...
  return (
    Object.defineProperty(t, "_vueTypes_isLoose", { writable: !0, value: !1 }),
    Object.defineProperty(t, "loose", {
      get() {
...
const te = ["name", "validate", "getter"],
  re = (e => (
    ((e = class {
      ...
      static get func() {
        return C().def(this.defaults.func);
      }
      static get bool() {
        return this.defaults.bool === void 0
          ? P()
          : P().def(this.defaults.bool);
      }
      static get string() {
      ...
      static get integer() {
        return U().def(this.defaults.integer);
      }
      static get symbol() {
        return z();
      }
      ...
      static extend(r) {
        if (
          ...
          return r.forEach(u => this.extend(u)), this;
        const { name: n, validate: t = !1, getter: i = !1 } = r,
          a = x(r, te);
        if (h(this, n))
              ...
              i
                ...
                : {
                    value(...u) {
                      ...
                      return (
                        l.validator &&
                          (l.validator = l.validator.bind(l, ...u)),
                        l
                      );
                    }
                  }
          ...
          (s = i
            ...
            : {
                value(...u) {
                  ...
                  return (
                    (p = t ? d(n, l) : f(n, l)),
                    l.validator && (p.validator = l.validator.bind(p, ...u)),
                    p
                  );
                },
                enumerable: !0
    ...
    (e.shape = ee),
    (e.utils = {
      validate: (r, n) => v(n, r, !0) === !0,
      toType: (r, n, t = !1) => (t ? d(r, n) : f(r, n))
    }),
    e
  ))();
function q(
...
class oe extends ne {
  static get style() {
    return d("style", { type: [String, Object] });
  }
  static get VNodeChild() {
    return d("VNodeChild", { type: void 0 });
  }
}
export { oe as p };
