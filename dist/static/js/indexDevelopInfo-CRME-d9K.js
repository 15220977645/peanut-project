import P from "./headTitle-DRjBlJXx.js";
import q from "./emptyData-Dt-o1_wc.js";
import {
  _ as D,
  r as m,
  e as M,
...
const B = { class: "box news-box" },
  G = { class: "scroll-develop" },
  C = { class: "scroll0" },
  E = { key: 0, class: "develop-info" },
  H = { class: "info-head" },
  O = { class: "info-content" },
  T = { class: "imgs" },
  Y = ["src"],
  k = ["innerHTML"],
  I = { key: 1, class: "empty-box" },
  A = {
    __name: "indexDevelopInfo",
    setup(L) {
      const w = m([]),
        g = m(null),
        d = m(!1),
        ...
        r = m(1),
        l = m(0),
        v = m(document.body.clientWidth);
      function h() {
        S();
      }
      function K() {
        var s, e;
        const i = document.getElementsByClassName("news-box")[0];
        p.value = i.getElementsByClassName("develop-block")[0];
        const n = (s = p.value) == null ? void 0 : s.offsetHeight,
          t =
            (e = i.getElementsByClassName("scroll-develop")[0]) == null
              ? void 0
              : e.offsetHeight;
        (l.value = t),
          t > n &&
            setTimeout(() => {
              (d.value = !0), (g.value = setInterval(Q, 300));
            }, 2e3);
      }
      async function S() {
        const i = [
...
<p><img class="rich_pages wxw-img" src="https://mmbiz.qpic.cn/mmbiz_jpg/MibZoS6RzG7S2jKK2vw9VoQewzQ262WcDcgWtDziaoibDRN46vnpbFcbiaYDOM6JDGjoicxXibiaqYURT5cPZYFicSqIlw/640?wx_fmt=jpeg&amp;tp=wxpic&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="图片" crossorigin="anonymous" data-galleryid="" data-ratio="1.9812252964426877" data-s="300,640" data-src="https://mmbiz.qpic.cn/mmbiz_jpg/MibZoS6RzG7S2jKK2vw9VoQewzQ262WcDcgWtDziaoibDRN46vnpbFcbiaYDOM6JDGjoicxXibiaqYURT5cPZYFicSqIlw/640?wx_fmt=jpeg" data-type="jpeg" data-w="1012" data-index="12" data-fail="0" /></p>"`
      ...
      async function Q() {
        ...
        if (d.value) {
          await y();
          const n = p.value.getElementsByClassName("scroll-develop")[0],
            t = n == null ? void 0 : n.children;
          ((i = p.value) == null ? void 0 : i.offsetHeight) - l.value >
            (n == null ? void 0 : n.offsetTop) && (t.length > 1 ? Z() : R());
          let e = n == null ? void 0 : n.offsetTop;
          (e = e - v.value * (10 / 1920)), (n.style.top = `${e}px`);
        }
      }
      function R() {
        const i = p.value.getElementsByClassName("scroll-develop")[0],
          n = i.getElementsByClassName("scroll0")[0],
          t = n.cloneNode(!0);
        i.appendChild(t);
        const s = i.getElementsByClassName("scroll0")[1];
        s.classList.add("scroll1"),
          s.classList.remove("scroll0"),
          (r.value = 0),
          (l.value = (n == null ? void 0 : n.offsetHeight) * 2);
      }
      function Z() {
        const i = r.value,
          n = p.value.getElementsByClassName("scroll-develop")[0],
          t = p.value.getElementsByClassName(`scroll${i}`)[0],
          s =
            Math.round(
              Math.abs(n == null ? void 0 : n.offsetTop) /
                ((t == null ? void 0 : t.offsetHeight) * 2)
            ) * 2;
        (t.style.top = `${(t == null ? void 0 : t.offsetHeight) * s}px`),
          (r.value = +!i),
          (l.value = l.value + (t == null ? void 0 : t.offsetHeight));
      }
      return (
        M(() => {
          h();
        ...
        (i, n) => (
          a(),
          c("div", B, [
            f(P, { name: "新闻动态", icon: "News-icon.svg" }),
            b(w).length > 0
              ? (a(),
                c(
                  "div",
                  {
                    key: 0,
                    class: "develop-block",
                    onMouseenter: n[0] || (n[0] = t => z(!1)),
                    onMouseout: n[1] || (n[1] = t => z(!0))
                  },
                  [
                    o("div", G, [
                      o("div", C, [
                        ...
                        c(
                          ...
                          _(
                            ...
                            (t, s) => (
                              a(),
                              c("div", { key: s }, [
                                t.fileList.length > 0 || t.richText !== ""
                                  ? (a(),
                                    c("div", E, [
                                      o("div", H, [
                                        o("div", null, [
