import h from "./headTitle-DRjBlJXx.js";
import v from "./emptyData-Dt-o1_wc.js";
import {
  _ as g,
  r as u,
  e as H,
...
const S = { class: "box foodBox" },
    ...
    setup(T) {
      ...
      return (
        ...
        (o, s) => (
          i(),
          l("div", S, [
            p(h, { icon: "FoodSafe-icon.svg", name: "食安看板" }),
            e("div", D, [
              s[0] ||
                (s[0] = e(
                  "ul",
  ...
  V = g(I, [["__scopeId", "data-v-2b0b12fd"]]);
export { V as default };
