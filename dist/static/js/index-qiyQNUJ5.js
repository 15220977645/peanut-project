import { S as bt, a as ln } from "./sortable.esm-DzfRfIj3.js";
import {
  h as _e,
  T as sn,
  d as Lt,
...
import { u as Et } from "./app-DOQ4rl_Q.js";
import { u as mn } from "./hooks-CSm4qXpW.js";
/**!
 * Sortable 1.14.0
...
function $(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? Dt(Object(n), !0).forEach(function (o) {
          gn(t, o, n[o]);
        })
      : Object.getOwnPropertyDescriptors
      ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n))
      : Dt(Object(n)).forEach(function (o) {
...
var Q = K(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Ae = K(/Edge/i),
  St = K(/firefox/i),
  Ce = K(/safari/i) && !K(/chrome/i) && !K(/android/i),
  Vt = K(/iP(ad|od|hone)/i),
  yn = K(/chrome/i) && K(/android/i),
  Xt = { capture: !1, passive: !1 };
function y(t, e, n) {
  t.addEventListener(e, n, !Q && Xt);
}
function b(t, e, n) {
  t.removeEventListener(e, n, !Q && Xt);
}
function je(t, e) {
  if (e) {
...
function G(t, e, n, o) {
  if (t) {
    ...
    do {
      if (
        (e != null &&
          (e[0] === ">" ? t.parentNode === n && je(t, e) : je(t, e))) ||
        (o && t === n)
      )
        return t;
      if (t === n) break;
  ...
  if (!(!t.getBoundingClientRect && t !== window)) {
    ...
    if (
      (t !== window && t.parentNode && t !== z()
        ...
        : ((a = 0),
          ...
          (f = window.innerWidth)),
      (e || n) && t !== window && ((r = r || t.parentNode), !Q))
    )
      do
        if (
          r &&
    ...
    if (o && t !== window) {
      var w = pe(r || t),
        v = w && w.a,
        _ = w && w.d;
      w && ((a /= _), (l /= v), (f /= v), (c /= _), (s = a + c), (u = l + f));
    }
    return { top: a, left: l, bottom: s, right: u, width: f, height: c };
  }
}
function xt(t, e, n) {
  for (var o = oe(t, !0), r = x(t)[e]; o; ) {
    var i = x(o)[n],
      a = void 0;
    if (((a = r >= i), !a)) return o;
    if (o === z()) break;
...
function pt(t, e) {
  for (
    ...
    n && (n === p.ghost || h(n, "display") === "none" || (e && !je(n, e)));
...
function oe(t, e) {
  if (!t || !t.getBoundingClientRect) return z();
  var n = t,
    o = !1;
  do
    if (n.clientWidth < n.scrollWidth || n.clientHeight < n.scrollHeight) {
      ...
      if (
        ...
        if (!n.getBoundingClientRect || n === document.body) return z();
        if (o || e) return n;
        o = !0;
      }
    }
  ...
  return {
      ...
      if (((t = []), !!this.options.animation)) {
        ...
        o.forEach(function (r) {
          if (!(h(r, "display") === "none" || r === p.ghost)) {
            t.push({ target: r, rect: x(r) });
            var i = $({}, t[t.length - 1].rect);
    ...
    animate: function (o, r, i, a) {
      if (a) {
        ...
        (o.animatingX = !!c),
          (o.animatingY = !!f),
          h(o, "transform", "translate3d(" + c + "px," + f + "px,0)"),
  ...
  Pe = {
    ...
    pluginEvent: function (e, n, o) {
      ...
      de.forEach(function (a) {
        n[a.pluginName] &&
          (n[a.pluginName][i] && n[a.pluginName][i]($({ sortable: n }, o)),
          n.options[a.pluginName] &&
            n[a.pluginName][e] &&
            n[a.pluginName][e]($({ sortable: n }, o)));
      });
    },
      ...
      return (
        de.forEach(function (r) {
          typeof r.eventProperties == "function" &&
            Z(o, r.eventProperties.call(n[r.pluginName], e));
        }),
        o
      );
    },
...
function In(t) {
  ...
  if (((e = e || (n && n[R])), !!e)) {
    ...
    window.CustomEvent && !Q && !Ae
      ? (_ = new CustomEvent(o, { bubbles: !0, cancelable: !0 }))
      : ((_ = document.createEvent("Event")), _.initEvent(o, !0, !0)),
      (_.to = a || n),
      (_.from = l || n),
      (_.item = r || n),
      (_.clone = i),
      (_.oldIndex = s),
      (_.newIndex = u),
      (_.oldDraggableIndex = c),
      (_.newDraggableIndex = f),
      (_.originalEvent = m),
      (_.pullMode = w ? w.lastPutMode : void 0);
    var O = $($({}, v), Pe.getEventProperties(o, e));
    for (var B in O) _[B] = O[B];
    n && n.dispatchEvent(_), X[U] && X[U].call(e, _);
  }
}
var On = ["evt"],
  N = function (e, n) {
      ...
      $(
        {
          ...
          dispatchSortableEvent: function (l) {
            P({ sortable: n, name: l, originalEvent: r });
          }
        },
        i
      )
...
var d,
  ...
  Re = Vt,
  At = Ae || Q ? "cssFloat" : "float",
  An = qe && !yn && !Vt && "draggable" in document.createElement("div"),
  jt = (function () {
    if (qe) {
      if (Q) return !1;
  ...
  Gt = function (e, n) {
    var o = h(e),
      ...
      l = i && h(i),
      s = a && h(a),
      u = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + x(i).width,
      c = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + x(a).width;
    if (o.display === "flex")
  ...
  zt = function (e) {
    function n(i, a) {
      return function (l, s, u, c) {
        ...
        if (typeof i == "function") return n(i(l, s, u, c), a)(l, s, u, c);
        var m = (a ? l : s).options.group.name;
        return (
          i === !0 ||
          (typeof i == "string" && i === m) ||
          (i.join && i.indexOf(m) > -1)
        );
      };
    }
    var o = {},
...
function p(t, e) {
  ...
  (this.el = t), (this.options = e = Z({}, e)), (t[R] = this);
  var n = {
    group: null,
    sort: !0,
    disabled: !1,
  ...
  (this.nativeDraggable = e.forceFallback ? !1 : An),
...
p.prototype = {
    ...
    if (e.cancelable) {
      ...
      if (
        ...
        !d &&
          ...
          ((s = G(s, r.draggable, o, !1)), !(s && s.animated) && Be !== s))
      ) {
        if (((he = V(s)), (Te = V(s, r.draggable)), typeof c == "function")) {
        ...
        (r.handle && !G(u, r.handle, o, !1)) || this._prepareDragStart(e, l, s);
      }
    }
  },
  _prepareDragStart: function (e, n, o) {
    ...
    if (o && !d && o.parentNode === i) {
      ...
      if (
        ...
        (It = le.clientX - u.left),
        (Ot = le.clientY - u.top),
        (this._lastX = (n || e).clientX),
        (this._lastY = (n || e).clientY),
        (d.style["will-change"] = "all"),
        (s = function () {
          if ((N("delayEnded", r, { evt: e }), p.eventCanceled)) {
            r._onDrop();
            return;
          }
          r._disableDelayedDragEvents(),
            !St && r.nativeDraggable && (d.draggable = !0),
            r._triggerDragStart(e, n),
            P({ sortable: r, name: "choose", originalEvent: e }),
            k(d, a.chosenClass, !0);
        }),
        ...
        y(l, "mousemove", se),
        y(l, "touchmove", se),
        y(l, "mouseup", r._onDrop),
        y(l, "touchend", r._onDrop),
        y(l, "touchcancel", r._onDrop),
        St &&
          this.nativeDraggable &&
        ...
        a.delay &&
          ...
          (!this.nativeDraggable || !(Ae || Q)))
      ) {
        if (p.eventCanceled) {
          this._onDrop();
          return;
        }
        y(l, "mouseup", r._disableDelayedDrag),
          y(l, "touchend", r._disableDelayedDrag),
          y(l, "touchcancel", r._disableDelayedDrag),
          y(l, "mousemove", r._delayedDragTouchMoveHandler),
          y(l, "touchmove", r._delayedDragTouchMoveHandler),
          a.supportPointer &&
            y(l, "pointermove", r._delayedDragTouchMoveHandler),
  ...
  _triggerDragStart: function (e, n) {
    (n = n || (e.pointerType == "touch" && e)),
      !this.nativeDraggable || n
        ...
        : (y(d, "dragend", this), y(E, "dragstart", this._onDragStart));
    try {
      document.selection
        ? He(function () {
  ...
  _emulateDragOver: function () {
    if (Y) {
      (this._lastX = Y.clientX), (this._lastY = Y.clientY), $t();
      for (
        var e = document.elementFromPoint(Y.clientX, Y.clientY), n = e;
        e &&
        e.shadowRoot &&
        ((e = e.shadowRoot.elementFromPoint(Y.clientX, Y.clientY)), e !== n);
  ...
  _onTouchMove: function (e) {
    if (le) {
      var n = this.options,
        ...
        u = Re && I && Tt(I),
        c =
          (i.clientX - le.clientX + r.x) / (l || 1) +
          (u ? u[0] - nt[0] : 0) / (l || 1),
        f =
          (i.clientY - le.clientY + r.y) / (s || 1) +
          (u ? u[1] - nt[1] : 0) / (s || 1);
      if (!p.active && !fe) {
        if (
          o &&
  ...
  _appendGhost: function () {
    if (!g) {
      var e = this.options.fallbackOnBody ? document.body : E,
        n = x(d, !0, Re, !0, e),
        o = this.options;
      if (Re) {
        for (
      ...
      (g = d.cloneNode(!0)),
        ...
        h(g, "height", n.height),
        h(g, "opacity", "0.8"),
        h(g, "position", Re ? "absolute" : "fixed"),
        h(g, "zIndex", "100000"),
        ...
        h(
          g,
          "transform-origin",
          (It / parseInt(g.style.width)) * 100 +
            "% " +
            (Ot / parseInt(g.style.height)) * 100 +
            "%"
        );
    }
  },
  _onDragStart: function (e, n) {
    ...
    N("setupClone", this),
      p.eventCanceled ||
        ...
        (S.style["will-change"] = ""),
        this._hideClone(),
        k(S, this.options.chosenClass, !1),
        (p.clone = S)),
      (o.cloneId = He(function () {
        N("clone", o),
          !p.eventCanceled &&
            (o.options.removeCloneOnHide || E.insertBefore(S, d),
            o._hideClone(),
            P({ sortable: o, name: "clone" }));
      })),
      !n && k(d, i.dragClass, !0),
      n
        ? ((Ge = !0), (o._loopId = setInterval(o._emulateDragOver, 50)))
        : (b(document, "mouseup", o._onDrop),
          b(document, "touchend", o._onDrop),
          b(document, "touchcancel", o._onDrop),
          r &&
            ((r.effectAllowed = "move"), i.setData && i.setData.call(o, r, d)),
          y(document, "drop", o),
          h(d, "transform", "translateZ(0)")),
      (fe = !0),
      (o._dragStartId = He(o._dragStarted.bind(o, n, e))),
      y(document, "selectstart", o),
      (Ee = !0),
  ...
  _onDragOver: function (e) {
        ...
        $(
          {
            ...
            target: o,
            completed: O,
            onMove: function (vt, an) {
              return Ve(E, n, d, r, vt, x(vt), e, an);
            },
            changed: B
          },
          rn
    ...
    function O(ye) {
      return (
        X("dragOverCompleted", { insertion: ye }),
        ye &&
          (c ? u._hideClone() : u._showClone(v),
          v !== m &&
            (k(d, T ? T.options.ghostClass : u.options.ghostClass, !1),
            k(d, l.ghostClass, !0)),
          T !== v && v !== p.active
            ? (T = v)
            : v === p.active && T && (T = null),
        ...
        ((o === d && !d.animated) || (o === n && !o.animated)) && (ce = null),
        !l.dragoverBubble &&
          !e.rootEl &&
          o !== document &&
          (d.parentNode[R]._isOutsideThisEl(e.target), !ye && se(e)),
    ...
    if (
      ...
      u &&
        ...
        (c
          ? f || (a = D !== E)
          : T === this ||
            ((this.lastPutMode = ke.checkPull(this, u, d, e)) &&
              s.checkPut(this, u, d, e))))
    ) {
      if (
        ((w = this._getDirection(e, o) === "vertical"),
        (r = x(d)),
        X("dragOverValid"),
        p.eventCanceled)
      )
      ...
      if (a)
        return (
          ...
          this._hideClone(),
          X("revert"),
          p.eventCanceled || (ue ? E.insertBefore(d, ue) : E.appendChild(d)),
          O(!0)
        );
      var H = pt(n, l.draggable);
      if (!H || (Rn(e, w, this) && !H.animated)) {
        if (H === d) return O(!1);
        if (
          (H && n === e.target && (o = H),
          o && (i = x(o)),
          Ve(E, n, d, r, o, i, e, !!o) !== !1)
        )
          return U(), n.appendChild(d), (D = n), B(), O(!0);
      } else if (H && Ln(e, w, this)) {
        var re = me(n, 0, l, !0);
        if (re === d) return O(!1);
        if (((o = re), (i = x(o)), Ve(E, n, d, r, o, i, e, !1) !== !1))
          return U(), n.insertBefore(d, re), (D = n), B(), O(!0);
        ...
        var W = 0,
          ...
          ge = d.parentNode !== n,
          F = !Pn(
            (d.animated && d.toRect) || r,
            (o.animated && o.toRect) || i,
            w
          ),
          ve = w ? "top" : "left",
          J = xt(o, "top", "top") || xt(d, "top", "top"),
          be = J ? J.scrollTop : void 0;
        ce !== o &&
          ((ie = i[ve]), (Oe = !1), (Le = (!F && l.invertSwap) || ge)),
          (W = Vn(
            e,
            o,
            i,
        ...
        if (W !== 0) {
          var ae = V(d);
          do (ae -= W), (q = D.children[ae]);
          while (q && (h(q, "display") === "none" || q === g));
        }
        if (W === 0 || q === o) return O(!1);
        (ce = o), (Ie = W);
        var we = o.nextElementSibling,
          ee = !1;
        ee = W === 1;
        var Ne = Ve(E, n, d, r, o, i, e, ee);
        if (Ne !== !1)
          return (
            (Ne === 1 || Ne === -1) && (ee = Ne === 1),
            (ut = !0),
            ...
            ee && !we
              ? n.appendChild(d)
              : o.parentNode.insertBefore(d, ee ? we : o),
            J && Ht(J, 0, be - J.scrollTop),
            (D = d.parentNode),
            ie !== void 0 && !Le && (Ye = Math.abs(ie - x(o)[ve])),
            B(),
            O(!0)
          );
      }
  ...
  _offMoveEvents: function () {
    b(document, "mousemove", this._onTouchMove),
      ...
      b(document, "dragover", se),
      b(document, "mousemove", se),
      b(document, "touchmove", se);
  },
  ...
  _onDrop: function (e) {
    ...
    (fe = !1),
      ...
      this.nativeDraggable &&
        (b(document, "drop", this), b(n, "dragstart", this._onDragStart)),
      this._offMoveEvents(),
      this._offUpEvents(),
      ...
      e &&
        ...
        d &&
          ...
          Ee &&
            !fe &&
            k(d, T ? T.options.ghostClass : this.options.ghostClass, !1),
          ...
          E !== D
            ? (L >= 0 &&
                ...
                P({ sortable: this, name: "sort", toEl: D, originalEvent: e })),
              T && T.save())
            : L !== he &&
              L >= 0 &&
              (P({ sortable: this, name: "update", toEl: D, originalEvent: e }),
              P({ sortable: this, name: "sort", toEl: D, originalEvent: e })),
          p.active &&
            ((L == null || L === -1) && ((L = he), (te = Te)),
            P({ sortable: this, name: "end", toEl: D, originalEvent: e }),
            this.save()))),
      this._nulling();
  },
  _nulling: function () {
  ...
  toArray: function () {
    for (
      ...
      (n = o[r]),
        G(n, a.draggable, this.el, !1) &&
          e.push(n.getAttribute(a.dataIdAttr) || Bn(n));
    return e;
  },
  sort: function (e, n) {
    var o = {},
    ...
    this.toArray().forEach(function (i, a) {
      var l = r.children[a];
      G(l, this.options.draggable, r, !1) && (o[i] = l);
    }, this),
  ...
  option: function (e, n) {
    ...
    typeof r < "u" ? (o[e] = r) : (o[e] = n), e === "group" && zt(o);
  },
  destroy: function () {
    N("destroy", this);
    var e = this.el;
    (e[R] = null),
      ...
      this._onDrop(),
      this._disableDelayedDragEvents(),
      ze.splice(ze.indexOf(this.el), 1),
      (this.el = e = null);
  },
  _hideClone: function () {
    if (!ne) {
  ...
  _showClone: function (e) {
    ...
    if (ne) {
      ...
      d.parentNode == E && !this.options.group.revertClone
        ? E.insertBefore(S, d)
        : ue
        ? E.insertBefore(S, ue)
        : E.appendChild(S),
...
function Ln(t, e, n) {
  var o = x(me(n.el, 0, n.options, !0)),
    r = 10;
  return e
    ? t.clientX < o.left - r || (t.clientY < o.top && t.clientX < o.right)
    : t.clientY < o.top - r || (t.clientY < o.bottom && t.clientX < o.left);
}
function Rn(t, e, n) {
  var o = x(pt(n.el, n.options.draggable)),
    r = 10;
  return e
    ? t.clientX > o.right + r ||
...
function Vn(t, e, n, o, r, i, a, l) {
  ...
  if (!a) {
    if (l && Ye < u * r) {
      if (
        (!Oe &&
          (Ie === 1 ? s > c + (u * i) / 2 : s < f - (u * i) / 2) &&
          (Oe = !0),
        Oe)
      )
        m = !0;
      else if (Ie === 1 ? s < c + Ye : s > f - Ye) return -Ie;
    } else if (s > c + (u * (1 - r)) / 2 && s < f - (u * (1 - r)) / 2)
      return Xn(e);
  }
  return (
    (m = m || a),
    m && (s < c + (u * i) / 2 || s > f - (u * i) / 2)
      ? s > c + u / 2
        ? 1
        : -1
      : 0
...
qe &&
  y(document, "touchmove", function (t) {
    (p.active || fe) && t.cancelable && t.preventDefault();
  });
p.utils = {
  on: y,
  off: b,
...
p.mount = function () {
  ...
  e[0].constructor === Array && (e = e[0]),
    e.forEach(function (o) {
      ...
      o.utils && (p.utils = $($({}, p.utils), o.utils)), Pe.mount(o);
    });
};
...
function Hn() {
  ...
  return (
    (t.prototype = {
      ...
      nulling: function () {
        (Ue = ct = De = ft = Se = rt = it = null), (C.length = 0);
      },
      ...
      _handleAutoScroll: function (n, o) {
        ...
        if (
          ((Ue = n), o || this.options.forceAutoScrollFallback || Ae || Q || Ce)
        ) {
          at(n, this.options, l, o);
          var s = oe(l, !0);
          ft &&
            (!Se || i !== rt || a !== it) &&
            (Se && Pt(),
            (Se = setInterval(function () {
              var u = oe(document.elementFromPoint(i, a), !0);
              u !== s && ((s = u), We()), at(n, r.options, u, o);
            }, 10)),
            (rt = i),
            (it = a));
        } else {
          if (!this.options.bubbleScroll || oe(l, !0) === z()) {
            We();
            return;
          }
          at(n, this.options, oe(l, !1), !1);
        }
      }
    }),
    Z(t, { pluginName: "scroll", initializeByDefault: !0 })
  );
}
function We() {
          ...
          ? ((re =
            ...
            (W =
              ...
              (F.overflowY === "auto" ||
                ...
                F.overflowY === "visible")))
          : ((re =
              B < ie && (F.overflowX === "auto" || F.overflowX === "scroll")),
            (W =
              H < ge && (F.overflowY === "auto" || F.overflowY === "scroll")));
        var be =
            re &&
            (Math.abs(O - r) <= a && ve + B < ie) -
              (Math.abs(U - r) <= a && !!ve),
          q =
            W &&
            (Math.abs(X - i) <= a && J + H < ge) -
              (Math.abs(_ - i) <= a && !!J);
        if (!C[f]) for (var ae = 0; ae <= f; ae++) C[ae] || (C[ae] = {});
        (C[f].vx != be || C[f].vy != q || C[f].el !== w) &&
          ((C[f].el = w),
          (C[f].vx = be),
          (C[f].vy = q),
          clearInterval(C[f].pid),
          (be != 0 || q != 0) &&
            ((u = !0),
            (C[f].pid = setInterval(
              function () {
                o && this.layer === 0 && p.active._onTouchMove(Ue);
                var we = C[this.layer].vy ? C[this.layer].vy * l : 0,
                  ee = C[this.layer].vx ? C[this.layer].vx * l : 0;
                (typeof c == "function" &&
                  c.call(
                    p.dragged.parentNode[R],
                    ee,
                    we,
                    t,
                    Ue,
                  ...
                  Ht(C[this.layer].el, ee, we);
              }.bind({ layer: f }),
              24
            )))),
          f++;
      } while (e.bubbleScroll && m !== s && (m = oe(m, !1)));
      ft = u;
    }
  }, 30),
  qt = function (e) {
...
const zn = /-(\w)/g,
  $n = Gn(t => t.replace(zn, (e, n) => n.toUpperCase())),
  Kt = ["Start", "Add", "Remove", "Update", "End"],
  Zt = ["Choose", "Unchoose", "Sort", "Filter", "Clone"],
  Qt = ["Move"],
  Un = [Qt, Kt, Zt].flatMap(t => t).map(t => `on${t}`),
  ht = { manage: Qt, manageAndEmit: Kt, emit: Zt };
function qn(t) {
...
function Jn({ $attrs: t, componentData: e = {} }) {
  return { ...en(Object.entries(t).filter(([o, r]) => Jt(o))), ...e };
}
function eo({ $attrs: t, callBackBuilder: e }) {
  const n = en(tn(t));
...
const Ft = ({ el: t }) => t,
  to = (t, e) => (t.__draggable_context = e),
  Mt = t => t.__draggable_context;
class no {
  constructor({
    ...
    (this.defaultNodes = n),
      (this.children = [...e, ...n, ...o]),
      (this.externalComponent = r.externalComponent),
      (this.rootTransition = r.transition),
      (this.tag = r.tag),
      (this.realList = i);
  }
...
function ro({ $slots: t, realList: e, getKey: n }) {
  const o = e || [],
    [r, i] = ["header", "footer"].map(s => oo(t, s)),
    { item: a } = t;
  ...
  const l = o.flatMap((s, u) =>
    a({ element: s, index: u }).map(
      c => (
        (c.key = n(s)),
        (c.props = { ...(c.props || {}), "data-draggable": !0 }),
        c
      )
    )
  );
  ...
  return { header: r, footer: i, default: l };
}
function io(t) {
  const e = Qn(t),
    n = !Zn(t) && !e;
  return { transition: e, externalComponent: n, tag: n ? _e(t) : e ? sn : t };
}
function ao({ $slots: t, tag: e, realList: n, getKey: o }) {
  const r = ro({ $slots: t, realList: n, getKey: o }),
    i = io(e);
  return new no({ nodes: r, root: i, realList: n });
}
function nn(t, e) {
...
function lo(t) {
  ...
  return (n, o) => {
    e.call(this, n, o), nn.call(this, t, n);
  };
}
let st = null;
const so = {
  ...
  uo = [
    "update:modelValue",
    "change",
    ...[...ht.manageAndEmit, ...ht.emit].map(t => t.toLowerCase())
  ],
  kt = Lt({
    name: "draggable",
    inheritAttrs: !1,
    ...
    render() {
      try {
        ...
        const {
          ...
          a = ao({ $slots: t, tag: n, realList: r, getKey: i });
        this.componentStructure = a;
        const l = Jn({ $attrs: e, componentData: o });
        return a.render(wt, l);
      } catch (t) {
        return (
          (this.error = !0), wt("pre", { style: { color: "red" } }, t.stack)
        );
      }
    },
    created() {
    ...
    mounted() {
      ...
      const o = eo({
          $attrs: t,
          callBackBuilder: {
            manageAndEmit: i => lo.call(this, i),
            emit: i => nn.bind(this, i),
            manage: i => on.call(this, i)
          }
        }),
        r = e.nodeType === 1 ? e : e.parentElement;
      (this._sortable = new p(r, o)),
        (this.targetDomElement = r),
    ...
    methods: {
      ...
      onDragRemove(t) {
        if ((Nt(this.$el, t.item, t.oldIndex), t.pullMode === "clone")) {
          lt(t.clone);
          return;
        }
      ...
      onDragUpdate(t) {
        lt(t.item), Nt(t.from, t.item, t.oldIndex);
      ...
      computeFutureIndex(t, e) {
        ...
        const n = [...e.to.children].filter(a => a.style.display !== "none"),
          ...
          r = t.component.getVmIndexFromDomIndex(o);
        return n.indexOf(st) !== -1 || !e.willInsertAfter ? r : r + 1;
      },
      onDragMove(t, e) {
        ...
        const r = this.getRelatedContextFromMoveEvent(t),
          ...
          a = { ...this.context, futureIndex: i },
          l = { ...t, relatedContext: r, draggedContext: a };
        return n(l, e);
      },
      onDragEnd() {
        st = null;
  ...
  fo = { class: "card-header" },
  ho = { class: "font-medium" },
  po = { class: "drag-container" },
  mo = { class: "item-single" },
  go = { class: "cut-container" },
  vo = Lt({
    name: "Draggable",
    __name: "index",
    setup(t) {
      const { setSortSwap: e } = Et(),
        n = Ke([
          { grid: "cn", num: 1 },
          { grid: "cn", num: 2 },
          { grid: "cn", num: 3 },
      ...
      return (
        un(() => {
          Et().sortSwap || bt.mount(new ln()),
            e(!0),
            new bt(document.querySelector(".cut-container"), {
              swap: !0,
              forceFallback: !0,
              chosenClass: "chosen",
              swapClass: "highlight",
                                        ...
                                        yt(
                                          ...
                                          fn(
                                            ...
                                            (m, w) => (
                                              ...
                                              yt(
                                                "div",
                                                { class: "item-cut", key: w },
                                                [M("p", null, Me(m.name), 1)]
                                              )
                                            )
                                          ),
                                          128
  ...
  Do = pn(vo, [["__scopeId", "data-v-415f9e94"]]);
