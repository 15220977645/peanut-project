...
de();
const Te = Ie((e, t, i, s, r, a) => (_(), U("div", Oe)));
H.render = Te;
...
function De(e, t, i) {
  return t && ke(e.prototype, t), e;
}
function X(e) {
  return Re(e) || Ae(e) || xe(e) || Me();
}
function Re(e) {
...
function Ue(e, t) {
  var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
    ...
    l = function (n) {
      for (
        var h = arguments.length, p = new Array(h > 1 ? h - 1 : 0), z = 1;
        z < h;
        z++
      )
        p[z - 1] = arguments[z];
      if (((a = p), !(s && n === r))) {
        var I = i.leading;
        typeof I == "function" && (I = I(n, r)),
          (!s || n !== r) && I && e.apply(void 0, [n].concat(X(a))),
          (r = n),
          clearTimeout(s),
          (s = setTimeout(function () {
            e.apply(void 0, [n].concat(X(a))), (s = 0);
          }, t));
      }
    };
  return (
...
function te(e, t) {
  if (e === t) return !0;
  if (P(e) === "object") {
    for (var i in e) if (!te(e[i], t[i])) return !1;
    return !0;
  }
  return !1;
}
    ...
    De(e, [
      {
        ...
        value: function (i, s) {
          ...
          if ((this.observer && this.destroyObserver(), !this.frozen)) {
            if (
              ((this.options = Pe(i)),
              (this.callback = function (o, n) {
                r.options.callback(o, n),
                  o && r.options.once && ((r.frozen = !0), r.destroyObserver());
              }),
              this.callback && this.options.throttle)
            ) {
              var a = this.options.throttleOptions || {},
                l = a.leading;
            ...
            (this.oldResult = void 0),
              (this.observer = new IntersectionObserver(function (o) {
                ...
                if (r.callback) {
                  var p =
                    n.isIntersecting && n.intersectionRatio >= r.threshold;
...
function Ce(e, t, i) {
  ...
  if (!te(s, r)) {
    ...
    a ? a.createObserver(s, i) : ie(e, { value: s }, i);
  }
}
function se(e) {
...
var Ee = { beforeMount: ie, updated: Ce, unmounted: se };
function Fe(e) {
  return {
    all: (e = e || new Map()),
    on: function (t, i) {
...
var Ne = { itemsLimit: 1e3 },
  Le = /(auto|scroll)/;
function re(e, t) {
  return e.parentNode === null ? t : re(e.parentNode, t.concat([e]));
}
var C = function (t, i) {
...
function J(e) {
  if (e instanceof HTMLElement || e instanceof SVGElement) {
    for (var t = re(e.parentNode, []), i = 0; i < t.length; i += 1)
      if (je(t[i])) return t[i];
...
function le() {
  return this.items.length && N(this.items[0]) !== "object";
}
var L = !1;
if (typeof window < "u") {
  L = !1;
  try {
    ...
    window.addEventListener("test", null, We);
  } catch {}
}
let qe = 0;
var B = {
  name: "RecycleScroller",
  components: { ResizeObserver: H },
  directives: { ObserveVisibility: Ee },
  props: {
    ...ne,
  ...
  methods: {
    addView(e, t, i, s, r) {
      const a = ue({ id: qe++, index: t, used: !0, key: s, type: r }),
        l = fe({ item: i, position: 0, nr: a });
      return e.push(l), l;
    },
    unuseView(e, t = !1) {
    ...
    updateVisibleItems(e, t = !1) {
      const i = this.itemSize,
        ...
        I = this.$_unusedViews,
        D = this.pool,
        ae = this.itemIndexByKey;
      let v, u, V, g, S;
      if (!h) v = u = g = S = V = 0;
      else if (this.$_prerender)
        (v = g = 0), (u = S = Math.min(this.prerender, n.length)), (V = null);
      else {
        ...
        if (
          (this.$refs.before &&
            ((f = this.$refs.before.scrollHeight), (c.start -= f)),
          this.$refs.after)
        ) {
        ...
        if (i === null) {
          ...
          do
            (q = b),
              ...
              m < c.start
                ? (k = b)
                : b < h - 1 && p[b + 1].accumulator > c.start && (W = b),
              (b = ~~((k + W) / 2));
          while (b !== q);
          for (
            b < 0 && (b = 0), v = b, V = p[h - 1].accumulator, u = b;
            u < h && p[u].accumulator < c.end;
            u++
          );
          for (
            u === -1 ? (u = n.length - 1) : (u++, u > h && (u = h)), g = v;
            g < h && f + p[g].accumulator < c.start;
            g++
          );
          ...
          const m = v % s;
          (v -= m),
            (u = Math.ceil((c.end / i) * s)),
            (g = Math.max(0, Math.floor(((c.start - f) / i) * s))),
            (S = Math.floor(((c.end - f) / i) * s)),
            v < 0 && (v = 0),
            u > h && (u = h),
            g < 0 && (g = 0),
            S > h && (S = h),
      ...
      u - v > Ne.itemsLimit && this.itemsLimitError(), (this.totalSize = V);
      let d;
      const R = v <= this.$_endIndex && u >= this.$_startIndex;
      if (R)
        for (let c = 0, y = D.length; c < y; c++)
          (d = D[c]),
            d.nr.used &&
              (e && (d.nr.index = ae[d.item[o]]),
              (d.nr.index == null || d.nr.index < v || d.nr.index >= u) &&
                this.unuseView(d));
      const j = R ? null : new Map();
      let O, $, A;
      for (let c = v; c < u; c++) {
        O = n[c];
        const y = o ? O[o] : O;
        ...
        (d.item = O),
          m &&
            (c === n.length - 1 && this.$emit("scroll-end"),
            c === 0 && this.$emit("scroll-start")),
          i === null
            ? ((d.position = p[c - 1].accumulator), (d.offset = 0))
            : ((d.position = Math.floor(c / s) * i), (d.offset = (c % s) * r));
      }
      return (
        (this.$_startIndex = v),
        (this.$_endIndex = u),
        this.emitUpdate && this.$emit("update", v, u, g, S),
    ...
    getScroll() {
      ...
      if (this.pageMode) {
        const r = e.getBoundingClientRect(),
          a = i ? r.height : r.width;
        let l = -(i ? r.top : r.left),
        ...
        i
          ? (s = { start: e.scrollTop, end: e.scrollTop + e.clientHeight })
          : (s = { start: e.scrollLeft, end: e.scrollLeft + e.clientWidth });
      return s;
    },
    applyPageMode() {
    ...
    scrollToItem(e) {
      ...
      this.itemSize === null
        ...
        : (t = Math.floor(e / i) * this.itemSize),
    ...
    scrollToPosition(e) {
      ...
      if (this.pageMode) {
        const a = J(this.$el),
          l = a.tagName === "HTML" ? 0 : a[t.scroll],
          o = a.getBoundingClientRect(),
          h = this.$el.getBoundingClientRect()[t.start] - o[t.start];
...
const Ke = { key: 0, ref: "before", class: "vue-recycle-scroller__slot" },
  Ye = { key: 1, ref: "after", class: "vue-recycle-scroller__slot" };
function Ge(e, t, i, s, r, a) {
  const l = Z("ResizeObserver"),
    o = pe("observe-visibility");
  return ve(
    (_(),
    x(
      "div",
      {
        ...
        onScrollPassive:
          t[0] || (t[0] = (...n) => a.handleScroll && a.handleScroll(...n))
      },
      [
        e.$slots.before
          ? (_(), x("div", Ke, [w(e.$slots, "before")], 512))
          : K("v-if", !0),
        (_(),
        U(
          Y(i.listTag),
          {
            ...
            class: G(["vue-recycle-scroller__item-wrapper", i.listClass])
          },
          {
            default: T(() => [
              (_(!0),
        ...
        e.$slots.after
          ? (_(), x("div", Ye, [w(e.$slots, "after")], 512))
          : K("v-if", !0),
        ye(l, { onNotify: a.handleResize }, null, 8, ["onNotify"])
      ],
      34
    )),
...
B.render = Ge;
B.__file = "src/components/RecycleScroller.vue";
var oe = {
  name: "DynamicScroller",
  components: { RecycleScroller: B },
  provide() {
    return (
  ...
  inheritAttrs: !1,
  props: { ...ne, minItemSize: { type: [Number, String], required: !0 } },
    ...
    itemsWithSize() {
      ...
      for (let l = 0; l < a; l++) {
        const o = t[l],
          n = s ? l : o[i];
        let h = r[n];
        typeof h > "u" && !this.$_undefinedMap[n] && (h = 0),
          e.push({ item: o, id: n, size: h });
      }
      return e;
    }
  },
  watch: {
    ...
    itemsWithSize(e, t) {
      ...
      for (let o = 0; o < a && !(s >= i); o++)
        (s += t[o].size || this.minItemSize),
          (r += e[o].size || this.minItemSize);
      const l = r - s;
  ...
  methods: {
    ...
    onScrollerVisible() {
      this.$_events.emit("vscroll:update", { force: !1 }),
        this.$emit("visible");
    },
    forceUpdate(e = !1) {
      (e || this.simpleArray) && (this.vscrollData.sizes = {}),
        this.$_events.emit("vscroll:update", { force: !0 });
    },
    scrollToItem(e) {
    ...
    getItemSize(e, t = void 0) {
      const i = this.simpleArray
        ? t ?? this.items.indexOf(e)
        : e[this.keyField];
...
function Xe(e, t, i, s, r, a) {
  const l = Z("RecycleScroller");
  return (
    _(),
    U(
      l,
      ee(
        ...
        e.$attrs,
        { onResize: a.onScrollerResize, onVisible: a.onScrollerVisible }
      ),
      {
        default: T(({ item: o, index: n, active: h }) => [
          w(
            e.$slots,
            "default",
            $e(_e({ item: o.item, index: n, active: h, itemWithSize: o }))
          )
        ]),
        before: T(() => [w(e.$slots, "before")]),
        after: T(() => [w(e.$slots, "after")]),
        empty: T(() => [w(e.$slots, "empty")]),
        _: 3
      },
      16,
      [
...
oe.render = Xe;
oe.__file = "src/components/DynamicScroller.vue";
var Je = {
  ...
  methods: {
    ...
    onVscrollUpdate({ force: e }) {
      !this.finalActive && e && (this.$_pendingVScrollUpdate = this.id),
        (this.$_forceNextVScrollUpdate === this.id || e || !this.size) &&
          this.updateSize();
    },
    onDataUpdate() {
      this.updateSize();
...
Je.__file = "src/components/DynamicScrollerItem.vue";
export { Je as a, oe as s };
