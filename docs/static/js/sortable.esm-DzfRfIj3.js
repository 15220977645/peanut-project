...
var K = V(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  Ot = V(/Edge/i),
  fe = V(/firefox/i),
  Dt = V(/safari/i) && !V(/chrome/i) && !V(/android/i),
  ie = V(/iP(ad|od|hone)/i),
  be = V(/chrome/i) && V(/android/i),
  we = { capture: !1, passive: !1 };
function v(o, t, e) {
  o.addEventListener(t, e, !K && we);
}
function m(o, t, e) {
  o.removeEventListener(t, e, !K && we);
}
function Bt(o, t) {
  if (t) {
...
function G(o, t, e, n) {
  if (o) {
    ...
    do {
      if (
        (t != null &&
          (t[0] === ">" ? o.parentNode === e && Bt(o, t) : Bt(o, t))) ||
        (n && o === e)
      )
        return o;
      if (o === e) break;
  ...
  if (!(!o.getBoundingClientRect && o !== window)) {
    ...
    if (
      (o !== window && o.parentNode && o !== z()
        ...
        : ((a = 0),
          ...
          (c = window.innerWidth)),
      (t || e) && o !== window && ((i = i || o.parentNode), !K))
    )
      do
        if (
          i &&
    ...
    if (n && o !== window) {
      var y = dt(i || o),
        w = y && y.a,
        E = y && y.d;
      y && ((a /= E), (l /= w), (c /= w), (d /= E), (s = a + d), (u = l + c));
    }
    return { top: a, left: l, bottom: s, right: u, width: c, height: d };
  }
}
function de(o, t, e) {
  for (var n = et(o, !0), i = C(o)[t]; n; ) {
    var r = C(n)[e],
      a = void 0;
    if (((a = i >= r), !a)) return n;
    if (n === z()) break;
...
function re(o, t) {
  for (
    ...
    e && (e === p.ghost || h(e, "display") === "none" || (t && !Bt(e, t)));
      ...
      o.forEach(function (l) {
        ...
        E && ((c.top -= E.f), (c.left -= E.e)),
          ...
          u.thisAnimationDuration &&
            jt(b, c) &&
            !jt(d, c) &&
            (w.top - c.top) / (w.left - c.left) ===
              (d.top - c.top) / (d.left - c.left) &&
            (s = Le(w, b, y, i.options)),
          jt(c, d) ||
            ((u.prevFromRect = d),
            (u.prevToRect = c),
...
var st = [],
  ...
  It = {
    mount: function (t) {
      for (var e in $t) $t.hasOwnProperty(e) && !(e in t) && (t[e] = $t[e]);
...
function ze(o) {
  var t = o.sortable,
    ...
    b = o.originalEvent,
    y = o.putSortable,
    w = o.extraEventProperties;
  if (((t = t || (e && e[F])), !!t)) {
    var E,
      B = t.options,
      q = "on" + n.charAt(0).toUpperCase() + n.substr(1);
    window.CustomEvent && !K && !Ot
    ...
    var P = j(j({}, w), It.getEventProperties(n, t));
    for (var H in P) E[H] = P[H];
    e && e.dispatchEvent(E), B[q] && B[q].call(t, E);
  }
}
var je = ["evt"],
  x = function (t, e) {
...
var f,
  ...
  xt = ie,
  me = Ot || K ? "cssFloat" : "float",
  $e = zt && !be && !ie && "draggable" in document.createElement("div"),
  Ce = (function () {
    if (zt) {
      if (K) return !1;
...
var at = function (t) {
  ...
  Ve = function (t) {
    f && f.parentNode[F]._isOutsideThisEl(t.target);
  };
function p(o, t) {
  ...
  (this.el = o), (this.options = t = $({}, t)), (o[F] = this);
  var e = {
    group: null,
    sort: !0,
    disabled: !1,
    ...
    supportPointer:
      p.supportPointer !== !1 && "PointerEvent" in window && (!Dt || ie),
    emptyInsertThreshold: 5
  };
  It.initializePlugins(this, o, e);
...
p.prototype = {
    ...
    if (t.cancelable) {
      ...
      if (
        ...
        !f &&
          ...
          ((s = G(s, i.draggable, n, !1)), !(s && s.animated) && Rt !== s))
      ) {
        if (((ct = M(s)), (_t = M(s, i.draggable)), typeof d == "function")) {
  ...
  _dragStarted: function (t, e) {
    if (((ft = !1), D && f)) {
      x("dragStarted", this, { evt: e }),
        this.nativeDraggable && v(document, "dragover", Ve);
      var n = this.options;
      !t && A(f, n.dragClass, !1),
        A(f, n.ghostClass, !0),
        (p.active = this),
  ...
  _emulateDragOver: function () {
    if (W) {
      (this._lastX = W.clientX), (this._lastY = W.clientY), Ae();
      for (
        var t = document.elementFromPoint(W.clientX, W.clientY), e = t;
        t &&
        t.shadowRoot &&
        ((t = t.shadowRoot.elementFromPoint(W.clientX, W.clientY)), t !== e);

      )
        e = t;
      if ((f.parentNode[F]._isOutsideThisEl(t), e))
        do {
          if (e[F]) {
            var n = void 0;
            if (
  ...
  _onTouchMove: function (t) {
    if (rt) {
      var e = this.options,
        ...
        u = xt && I && he(I),
        d =
          (r.clientX - rt.clientX + i.x) / (l || 1) +
          (u ? u[0] - Vt[0] : 0) / (l || 1),
        c =
          (r.clientY - rt.clientY + i.y) / (s || 1) +
          (u ? u[1] - Vt[1] : 0) / (s || 1);
      if (!p.active && !ft) {
        if (
          n &&
  ...
  _appendGhost: function () {
    if (!g) {
      var t = this.options.fallbackOnBody ? document.body : D,
        e = C(f, !0, xt, !0, t),
        n = this.options;
      if (xt) {
        for (
      ...
      (g = f.cloneNode(!0)),
        ...
        h(
          g,
          "transform-origin",
          (pe / parseInt(g.style.width)) * 100 +
            "% " +
            (ge / parseInt(g.style.height)) * 100 +
            "%"
        );
    }
  },
  _onDragStart: function (t, e) {
    ...
    x("setupClone", this),
      p.eventCanceled ||
        ...
        (S.style["will-change"] = ""),
        this._hideClone(),
        A(S, this.options.chosenClass, !1),
        (p.clone = S)),
      (n.cloneId = Yt(function () {
        x("clone", n),
          !p.eventCanceled &&
      ...
      (ft = !0),
      (n._dragStartId = Yt(n._dragStarted.bind(n, e, t))),
      v(document, "selectstart", n),
      (wt = !0),
      window.getSelection().removeAllRanges(),
      Dt && h(document.body, "user-select", "none");
  },
  _onDragOver: function (t) {
        ...
        j(
          {
            ...
            target: n,
            completed: P,
            onMove: function (se, Me) {
              return Mt(D, e, f, i, se, C(se), t, Me);
            },
            changed: H
          },
          xe
    ...
    function q() {
      B("dragOverAnimationCapture"),
        ...
        w !== b && b.captureAnimationState();
    }
    function P(bt) {
      return (
        B("dragOverCompleted", { insertion: bt }),
        bt &&
          (d ? u._hideClone() : u._showClone(w),
          w !== b &&
            (A(f, O ? O.options.ghostClass : u.options.ghostClass, !1),
            A(f, l.ghostClass, !0)),
          O !== w && w !== p.active
            ? (O = w)
            : w === p.active && O && (O = null),
          b === w && (w._ignoreWhileAnimating = n),
          w.animateAll(function () {
            B("dragOverAnimationComplete"), (w._ignoreWhileAnimating = null);
          }),
          w !== b && (b.animateAll(), (b._ignoreWhileAnimating = null))),
        ((n === f && !f.animated) || (n === e && !n.animated)) && (ut = null),
        !l.dragoverBubble &&
          !t.rootEl &&
          n !== document &&
          (f.parentNode[F]._isOutsideThisEl(t.target), !bt && at(t)),
    ...
    if (
      ...
      u &&
        ...
        (d
          ? c || (a = _ !== D)
          : O === this ||
            ((this.lastPutMode = Pt.checkPull(this, u, f, t)) &&
              s.checkPut(this, u, f, t))))
    ) {
      if (
        ((y = this._getDirection(t, n) === "vertical"),
        (i = C(f)),
        B("dragOverValid"),
        p.eventCanceled)
      )
      ...
      if (a)
        return (
          ...
          this._hideClone(),
          B("revert"),
          p.eventCanceled || (lt ? D.insertBefore(f, lt) : D.appendChild(f)),
          P(!0)
        );
      var R = re(e, l.draggable);
      if (!R || (Je(t, y, this) && !R.animated)) {
        if (R === f) return P(!1);
        if (
          (R && e === t.target && (n = R),
          n && (r = C(n)),
          Mt(D, e, f, i, n, r, t, !!n) !== !1)
        )
          return (
            q(),
            R && R.nextSibling
              ? e.insertBefore(f, R.nextSibling)
              : e.appendChild(f),
            (_ = e),
            H(),
            P(!0)
          );
      } else if (R && Qe(t, y, this)) {
        var nt = ht(e, 0, l, !0);
        if (nt === f) return P(!1);
        if (((n = nt), (r = C(n)), Mt(D, e, f, i, n, r, t, !1) !== !1))
          return q(), e.insertBefore(f, nt), (_ = e), H(), P(!0);
        ...
        var L = 0,
          ...
          gt = y ? "top" : "left",
          Z = de(n, "top", "top") || de(f, "top", "top"),
          mt = Z ? Z.scrollTop : void 0;
        ut !== n &&
          ((ot = r[gt]), (Ct = !1), (Nt = (!X && l.invertSwap) || pt)),
          (L = tn(
            t,
            n,
            r,
        ...
        if (L !== 0) {
          var it = M(f);
          do (it -= L), (U = _.children[it]);
          while (U && (h(U, "display") === "none" || U === g));
        }
        if (L === 0 || U === n) return P(!1);
        (ut = n), (Tt = L);
        var vt = n.nextElementSibling,
          Q = !1;
        Q = L === 1;
        var At = Mt(D, e, f, i, n, r, t, Q);
        if (At !== !1)
          return (
            (At === 1 || At === -1) && (Q = At === 1),
            (te = !0),
            ...
            Q && !vt
              ? e.appendChild(f)
              : n.parentNode.insertBefore(f, Q ? vt : n),
            Z && Se(Z, 0, mt - Z.scrollTop),
            (_ = f.parentNode),
            ot !== void 0 && !Nt && (Xt = Math.abs(ot - C(n)[gt])),
            H(),
            P(!0)
          );
      }
  ...
  _offMoveEvents: function () {
    m(document, "mousemove", this._onTouchMove),
      ...
      m(document, "dragover", at),
      m(document, "mousemove", at),
      m(document, "touchmove", at);
  },
  ...
  _onDrop: function (t) {
    ...
    (ft = !1),
      ...
      this._offMoveEvents(),
      this._offUpEvents(),
      Dt && h(document.body, "user-select", ""),
      h(f, "transform", ""),
      t &&
        (wt &&
          (t.cancelable && t.preventDefault(),
        ...
        f &&
          ...
          wt &&
            !ft &&
            A(f, O ? O.options.ghostClass : this.options.ghostClass, !1),
          ...
          D !== _
            ? (Y >= 0 &&
                ...
                N({ sortable: this, name: "sort", toEl: _, originalEvent: t })),
              O && O.save())
            : Y !== ct &&
              Y >= 0 &&
              (N({ sortable: this, name: "update", toEl: _, originalEvent: t }),
              N({ sortable: this, name: "sort", toEl: _, originalEvent: t })),
          p.active &&
            ((Y == null || Y === -1) && ((Y = ct), (J = _t)),
            N({ sortable: this, name: "end", toEl: _, originalEvent: t }),
            this.save()))),
      this._nulling();
  },
  _nulling: function () {
    ...
    for (
      ...
      (e = n[i]),
        G(e, a.draggable, this.el, !1) &&
          t.push(e.getAttribute(a.dataIdAttr) || nn(e));
    return t;
  },
  sort: function (t, e) {
    var n = {},
  ...
  option: function (t, e) {
    ...
    var i = It.modifyOption(this, t, e);
...
function tn(o, t, e, n, i, r, a, l) {
  ...
  if (!a) {
    if (l && Xt < u * i) {
      if (
        (!Ct &&
          (Tt === 1 ? s > d + (u * r) / 2 : s < c - (u * r) / 2) &&
          (Ct = !0),
        Ct)
      )
        b = !0;
      else if (Tt === 1 ? s < d + Xt : s > c - Xt) return -Tt;
...
zt &&
  v(document, "touchmove", function (o) {
    (p.active || ft) && o.cancelable && o.preventDefault();
  });
p.utils = {
  on: v,
  off: m,
...
p.mount = function () {
  ...
  t[0].constructor === Array && (t = t[0]),
    t.forEach(function (n) {
      ...
      n.utils && (p.utils = j(j({}, p.utils), n.utils)), It.mount(n);
    });
};
...
function rn() {
  ...
  return (
    (o.prototype = {
      ...
      nulling: function () {
        (Lt = ne = Et = oe = yt = Zt = Qt = null), (T.length = 0);
      },
      ...
      _handleAutoScroll: function (e, n) {
        ...
        if (
          ((Lt = e), n || this.options.forceAutoScrollFallback || Ot || K || Dt)
        ) {
          Jt(e, this.options, l, n);
          var s = et(l, !0);
          oe &&
            (!yt || r !== Zt || a !== Qt) &&
            (yt && ve(),
            (yt = setInterval(function () {
              ...
              u !== s && ((s = u), kt()), Jt(e, i.options, u, n);
            }, 10)),
            (Zt = r),
            (Qt = a));
        } else {
          if (!this.options.bubbleScroll || et(l, !0) === z()) {
            kt();
            return;
          }
          Jt(e, this.options, et(l, !1), !1);
        }
      }
    }),
          ...
          ? ((nt =
            ...
            (L =
              ...
              (X.overflowY === "auto" ||
                ...
                X.overflowY === "visible")))
          : ((nt =
              H < ot && (X.overflowX === "auto" || X.overflowX === "scroll")),
            (L =
              R < pt && (X.overflowY === "auto" || X.overflowY === "scroll")));
        var mt =
            nt &&
            (Math.abs(P - i) <= a && gt + H < ot) -
              (Math.abs(q - i) <= a && !!gt),
          U =
            L &&
            (Math.abs(B - r) <= a && Z + R < pt) -
              (Math.abs(E - r) <= a && !!Z);
        if (!T[c]) for (var it = 0; it <= c; it++) T[it] || (T[it] = {});
        (T[c].vx != mt || T[c].vy != U || T[c].el !== y) &&
          ((T[c].el = y),
          (T[c].vx = mt),
          (T[c].vy = U),
          ...
          (mt != 0 || U != 0) &&
            ...
            (T[c].pid = setInterval(
              function () {
                ...
                var vt = T[this.layer].vy ? T[this.layer].vy * l : 0,
                ...
                (typeof d == "function" &&
                  ...
                  Se(T[this.layer].el, Q, vt);
              }.bind({ layer: c }),
              24
            )))),
          c++;
      } while (t.bubbleScroll && b !== s && (b = et(b, !1)));
      oe = u;
    }
  }, 30),
  Ne = function (t) {
...
ae.prototype = {
  ...
  onSpill: function (t) {
    ...
    var i = ht(this.sortable.el, this.startIndex, this.options);
    ...
    (o.prototype = {
      ...
      dragOverValid: function (e) {
        ...
        if (a.options.swap) {
          ...
          if (i && i !== u) {
            var c = k;
            r(i) !== !1 ? (A(i, d.swapClass, !0), (k = i)) : (k = null),
              c && c !== k && A(c, d.swapClass, !1);
          }
          l(), n(!0), s();
        }
      },
