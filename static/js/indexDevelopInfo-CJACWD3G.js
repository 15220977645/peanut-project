import P from"./headTitle-CEG0nuwy.js";import q from"./emptyData-CEnnijAF.js";import{_ as D,r as m,e as M,f as N,c,o as a,b as f,u as b,a as o,F as x,k as _,x as j,i as W,t as u,n as y}from"./index-PqeBK8Si.js";import"./requireImg-Bg5sYdkU.js";import"./fullscreen-Jd1QV4Xo.js";import"./title-r-icon-BVtdJZn6.js";import"./empty-CcM4PDmr.js";const B={class:"box news-box"},G={class:"scroll-develop"},C={class:"scroll0"},E={key:0,class:"develop-info"},H={class:"info-head"},O={class:"info-content"},T={class:"imgs"},Y=["src"],k=["innerHTML"],I={key:1,class:"empty-box"},A={__name:"indexDevelopInfo",setup(L){const w=m([]),g=m(null),d=m(!1),p=m(null),r=m(1),l=m(0),v=m(document.body.clientWidth);function h(){S()}function K(){var s,e;const i=document.getElementsByClassName("news-box")[0];p.value=i.getElementsByClassName("develop-block")[0];const n=(s=p.value)==null?void 0:s.offsetHeight,t=(e=i.getElementsByClassName("scroll-develop")[0])==null?void 0:e.offsetHeight;l.value=t,t>n&&setTimeout(()=>{d.value=!0,g.value=setInterval(Q,300)},2e3)}async function S(){const i=[{title:"乐苗「餐桌的故事」（一）：学生营养餐如何做？从食谱定制开始！",publishTime:"2023.11.10",content:`"<p><img class="rich_pages wxw-img __bg_gif" src="https://bucket-lehe.oss-cn-shenzhen.aliyuncs.com/food/J6GPd7XZta6JY4RN.png" alt="图片" crossorigin="anonymous" data-galleryid="" data-ratio="0.5032437442075997" data-src="https://mmbiz.qpic.cn/mmbiz_gif/MibZoS6RzG7S5K2mb4zwgXXEsXbSqcTLqz6wrIE3tHyicFAzMXcBHysPubmXu4Pslw3jpZuVpBSJtQnhOYTtj5qg/640?wx_fmt=gif" data-type="gif" data-w="1079" data-index="0" data-sec-load-status="2" data-order="0" /></p>
<section>
<p>&nbsp;</p>
<section>
<section>
...
<p><img class="rich_pages wxw-img" src="https://mmbiz.qpic.cn/mmbiz_jpg/MibZoS6RzG7S2jKK2vw9VoQewzQ262WcDcgWtDziaoibDRN46vnpbFcbiaYDOM6JDGjoicxXibiaqYURT5cPZYFicSqIlw/640?wx_fmt=jpeg&amp;tp=wxpic&amp;wxfrom=5&amp;wx_lazy=1&amp;wx_co=1" alt="图片" crossorigin="anonymous" data-galleryid="" data-ratio="1.9812252964426877" data-s="300,640" data-src="https://mmbiz.qpic.cn/mmbiz_jpg/MibZoS6RzG7S2jKK2vw9VoQewzQ262WcDcgWtDziaoibDRN46vnpbFcbiaYDOM6JDGjoicxXibiaqYURT5cPZYFicSqIlw/640?wx_fmt=jpeg" data-type="jpeg" data-w="1012" data-index="12" data-fail="0" /></p>"`}];i.forEach(n=>{var s;const t=[];n.content=(s=n.content)==null?void 0:s.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/g,function(){return t.push({url:"https://bucket-lehe.oss-cn-shenzhen.aliyuncs.com/food/J6GPd7XZta6JY4RN.png"}),""}),n.fileList=t}),w.value=i,await y(),K()}function z(i){d.value=i}async function Q(){var i;if(d.value){await y();const n=p.value.getElementsByClassName("scroll-develop")[0],t=n==null?void 0:n.children;((i=p.value)==null?void 0:i.offsetHeight)-l.value>(n==null?void 0:n.offsetTop)&&(t.length>1?Z():R());let e=n==null?void 0:n.offsetTop;e=e-v.value*(10/1920),n.style.top=`${e}px`}}function R(){const i=p.value.getElementsByClassName("scroll-develop")[0],n=i.getElementsByClassName("scroll0")[0],t=n.cloneNode(!0);i.appendChild(t);const s=i.getElementsByClassName("scroll0")[1];s.classList.add("scroll1"),s.classList.remove("scroll0"),r.value=0,l.value=(n==null?void 0:n.offsetHeight)*2}function Z(){const i=r.value,n=p.value.getElementsByClassName("scroll-develop")[0],t=p.value.getElementsByClassName(`scroll${i}`)[0],s=Math.round(Math.abs(n==null?void 0:n.offsetTop)/((t==null?void 0:t.offsetHeight)*2))*2;t.style.top=`${(t==null?void 0:t.offsetHeight)*s}px`,r.value=+!i,l.value=l.value+(t==null?void 0:t.offsetHeight)}return M(()=>{h()}),N(()=>{clearInterval(g.value)}),(i,n)=>(a(),c("div",B,[f(P,{name:"新闻动态",icon:"News-icon.svg"}),b(w).length>0?(a(),c("div",{key:0,class:"develop-block",onMouseenter:n[0]||(n[0]=t=>z(!1)),onMouseout:n[1]||(n[1]=t=>z(!0))},[o("div",G,[o("div",C,[(a(!0),c(x,null,_(b(w),(t,s)=>(a(),c("div",{key:s},[t.fileList.length>0||t.richText!==""?(a(),c("div",E,[o("div",H,[o("div",null,[n[2]||(n[2]=o("span",{class:"point"},null,-1)),W(u(t.title),1)]),o("div",null,u(t.publishTime),1)]),o("div",O,[o("div",T,[(a(!0),c(x,null,_(t.fileList,(e,V)=>(a(),c("img",{key:V,src:e.url,alt:""},null,8,Y))),128))]),o("div",{class:"rich-text",innerHTML:t.content},null,8,k)])])):j("",!0)]))),128))])])],32)):(a(),c("div",I,[f(q)]))]))}},sn=D(A,[["__scopeId","data-v-d645a66a"]]);export{sn as default};
